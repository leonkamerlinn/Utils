...
public class ItemAnimation {
    ...
    private static void animateBottomUp(View view, int position) {
        ...
        ObjectAnimator animatorTranslateY = ObjectAnimator.ofFloat(view, View.TRANSLATION_Y, not_first_item ? 800 : 500, 0);
        ObjectAnimator animatorAlpha = ObjectAnimator.ofFloat(view, View.ALPHA, 1.f);
    ...
    private static void animateFadeIn(View view, int position) {
        ...
        view.setAlpha(0.f);
        AnimatorSet animatorSet = new AnimatorSet();
        ObjectAnimator animatorAlpha = ObjectAnimator.ofFloat(view, View.ALPHA, 0.f, 0.5f, 1.f);
        ObjectAnimator.ofFloat(view, View.ALPHA, 0.f).start();
    ...
    private static void animateLeftRight(View view, int position) {
        ...
        view.setAlpha(0.f);
        AnimatorSet animatorSet = new AnimatorSet();
        ObjectAnimator animatorTranslateY = ObjectAnimator.ofFloat(view, View.TRANSLATION_X, -400f, 0);
        ObjectAnimator animatorAlpha = ObjectAnimator.ofFloat(view, View.ALPHA, 1.f);
        ObjectAnimator.ofFloat(view, View.ALPHA, 0.f).start();
    ...
    private static void animateRightLeft(View view, int position) {
        ...
        view.setAlpha(0.f);
        AnimatorSet animatorSet = new AnimatorSet();
        ObjectAnimator animatorTranslateY = ObjectAnimator.ofFloat(view, View.TRANSLATION_X, view.getX() + 400, 0);
        ObjectAnimator animatorAlpha = ObjectAnimator.ofFloat(view, View.ALPHA, 1.f);
        ObjectAnimator.ofFloat(view, View.ALPHA, 0.f).start();
